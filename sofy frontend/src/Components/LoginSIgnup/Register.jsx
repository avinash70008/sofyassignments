 ...
 const dispatch=useDispatch();
    ...
    <div>
        ...
        <div className="r2">
            ...
            <input className="r3" type="text" name="name" value={user.name} placeholder="Enter Your UserName" onChange={handleChange}/>
            <br />
            <br />
            <input className="r3" type="text" name="email" value={user.email} placeholder="Enter Your E-mail"  onChange={handleChange}/>
            <br /><br />
            <input className="r3" type="text" name="phone" value={user.phone} placeholder="Enter Your Mobile No"  onChange={handleChange}/>
            <br /><br />
            <input className="r3" type="text" name="role" value={user.role} placeholder="type Either Admin/Manager"  onChange={handleChange}/>
            <br /><br />
